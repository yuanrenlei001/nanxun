...
Page({
  ...
  list(){
    ...
    var that = this;
    wx.request({
      url: app.data.request_url+'/api/xcx/xcxPropaganda/getAll?pageNum='+pageNum+'&pageSize='+pageSize+'&type=VR',
      method: "get",
      data: {},
      dataType: "json",
...
inputTyping:function(e){
  ...
  var that = this;
  wx.request({
    url: app.data.request_url+'/api/xcx/xcxPropaganda/getAll?pageNum=1&pageSize=20&type=VR&keyword='+value,
    method: "get",
    data: {},
    dataType: "json",
    header: { 'content-type': 'application/x-www-form-urlencoded' },
