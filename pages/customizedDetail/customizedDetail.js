...
Page({
  ...
  detail:function(){
    ...
    wx.request({
      url: app.data.request_url+'/api/com/comRoute/getById?id='+this.data.mapId,
      method: "get",
      data: {},
      dataType: "json",
      header: { 
...
favorite:function(){
  ...
  var data = {
    ...
    'contentId':that.data.showList.id,
...
unfavorite:function(){
  ...
  var data = {
    ...
    'contentName':that.data.showList.name,
    'type':'经典游线',
    id:that.data.showList.ifFavorite
  }
  wx.request({
...
share:function(){
  let url = encodeURIComponent('/pages/customizedDetail/customizedDetail?id='+this.data.mapId);
 
    return {
      title: "路线攻略",
      path:`/pages/customizedDetail/customizedDetail?url=${url}` 
    }
