...
Page({
  ...
  detail:function(){
    ...
    wx.request({
      url: app.data.request_url+'/api/xcx/xcxTravel/getById?id='+this.data.mapId,
      method: "get",
      data: {},
      dataType: "json",
      header: { 
  ...
  var url = ''
  var data={
    dayNum:this.data.showList.dayNum,
    touristNum:this.data.showList.touristNum,
    label:this.data.showList.label
  }
        wx.request({
...
share:function(){
  let url = encodeURIComponent('/pages/customizedDetail2/customizedDetail2?id='+this.data.mapId);
